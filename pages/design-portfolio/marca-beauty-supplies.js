...
export default function MarcaBeauty() {
  return (
            ...
            <div className="single-portfolio-right">
              ...
              <div className="portfolio-single-description-wrapper flex align-center gap-3 border-[#30283b] border-2 rounded-lg py-2 px-3 mb-4">
                ...
                <p className="poppins-font text-[18px]">
                  Client:{" "}
                  <span className="font-bold">Marca Beauty Supplies</span>
                </p>
              </div>
              ...
              <div className="portfolio-single-description-wrapper flex align-center gap-3 border-[#30283b] border-2 rounded-lg py-2 px-3 mb-4">
                <img src="/tools.svg" />
                <p className="poppins-font text-[18px]">
                  Country: <span className="font-bold">Lebanon</span>
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-5 rounded-xl text-sm font-light text-white/90 shadow-sm space-y-3">
                ...
                <p className="poppins-font text-[16px]">
                  Marca Beauty Supplies, a Lebanon-based beauty and wellness
                  brand, partnered with us to develop a sophisticated and
                  luxurious identity. We designed a custom logo along with
                  complete branding including business cards, product packaging,
                  and promotional material.
                </p>
                <p className="poppins-font text-[16px]">
                  The brand aesthetic was built around elegance and minimalism,
                  ensuring a clean and modern feel across all customer
                  touchpoints. The final result captures the essence of premium
                  beauty products while maintaining a strong and memorable
                  visual presence.
                </p>
              </div>
            </div>
